...
TITLE_FONT = pygame.font.Font('fonts/Arvo-Bold.ttf', 50)
SIDE_FONT = pygame.font.Font('fonts/FrankRuhlLibre-Regular.ttf', 30)
...
def pause(surface, width, height, main, main_menu, get_leaderboard, player):
